...
import top.kdla.framework.supplement.fieldvaluefinder.annotation.FieldValueFind;
...
@Slf4j
@Component
public class FieldValueFindHelp {
    ...
    private void directQuery(ProcessFieldDto dto) {
        ...
        try {
            ...
            Object queryBean = ApplicationContextHelp.getBean(queryClass);
