...
import top.kdla.framework.supplement.sequence.no.model.rules.*;
import top.kdla.framework.supplement.sequence.no.model.rules.epoch.EpochRule;
import top.kdla.framework.supplement.sequence.no.model.rules.epoch.EpochRuleTypeEnum;
import top.kdla.framework.supplement.sequence.no.model.rules.random.RandomTypeEnum;
import top.kdla.framework.supplement.sequence.no.model.rules.random.RandomTypeRule;
import top.kdla.framework.supplement.sequence.no.model.rules.sequence.SequenceTypeRule;
