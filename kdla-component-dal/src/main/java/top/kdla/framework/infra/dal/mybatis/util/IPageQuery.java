...
public class IPageQuery<T> {
    ...
    public IPage<T> mapPage(Map<String, Object> params) {
        return this.mapPage(params, null, false);
    }

    public IPage<T> mapPage(Map<String, Object> params, String defaultOrderField, boolean isAsc) {
        //分页参数
        long curPage = 1;
        long limit = 10;
