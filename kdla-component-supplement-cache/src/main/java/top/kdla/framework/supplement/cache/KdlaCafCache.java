...
public class KdlaCafCache<T, E> {
     ...
     * 缓存过期时间，秒
     */
    @Value("${kdla.caffeine.expire.after.write:600}")
    private Long duration;
    /**
     * 缓存初始容量
     */
    @Value("${kdla.caffeine.initial.capacity:100}")
    private Integer initialCapacity;
    /**
     * 缓存最大容量
     */
    @Value("${kdla.caffeine.maximum.size:10000}")
    private Integer maximumSize;

    public void initKdlaCafCache() {
        this.init();
    }
     ...
     */
    public void initKdlaCafCache(Long duration, Integer maximumSize) {
        this.setCafCache(duration, maximumSize);
        this.init();
    }
     ...
     * @param maximumSize 最大容量，超过则移除
     */
    private void setCafCache(Long duration, Integer maximumSize) {
